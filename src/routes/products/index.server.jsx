...
import {
  CollectionLayoutBottomClient,
  CollectionLayoutTopClient,
} from '~/components/tapita/Specific/CollectionLayout.client';
...
export default function AllProducts() {
  ...
  return (
    <Layout>
      ...
      <PageHeader variant="allCollections" />
      <Section>
        <div className={'tapita-collection-fraction-top'}>
          <CollectionLayoutTopClient handle={''} intToken={intToken} />
        </div>
        ...
        <div className={'tapita-collection-fraction-bottom'}>
          <CollectionLayoutBottomClient handle={''} intToken={intToken} />
        </div>
      </Section>
    </Layout>
  );
